...
This directory contains example implementations using `@schaake-solutions/agents`.

## Prerequisites

Before running these examples, make sure you have:

1. Installed the `@schaake-solutions/agents` package
...
```typescript
import { OpenRouterProvider, createAgent, defineTool } from "@schaake-solutions/agents";
import { z } from "zod";
